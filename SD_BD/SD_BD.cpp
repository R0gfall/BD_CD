...
void add_hero(list** start) {
	...
	printf("-------------------------------------------------------------------------------------------------\n");
	printf(" Введите атрибут вашего героя: enforcer - 1, universal - 2, itnelligence - 3, dexterity - 4\n");
	printf("-------------------------------------------------------------------------------------------------\n");
...
void search_fp_hero(list* start, char* name)
{
	...
	printf("-----------------------------------------------\n");
	printf("Героя с таким именем не было найдено\n");
	printf("-----------------------------------------------\n");
}
...
void delete_fp_hero(list** start, char* name)
{
	...
	if ((memcmp(search->p_hero->name_hero, name, size_arrive(name)) == 0) && (size_arrive(name) == size_arrive(search->p_hero->name_hero))) {
		...
		*start = search;
		printf("\n--------------------------------------------------------------\n");
		printf("%s был успешно удален из базы данных\n", name);
		printf("--------------------------------------------------------------\n\n");
		return;
	}
	...
	while (search->p_next_hero != NULL) {
		...
		if ((memcmp((search->p_next_hero)->p_hero->name_hero, name, size_arrive(name)) == 0) && (size_arrive(name) == size_arrive((search->p_next_hero)->p_hero->name_hero))) {
			...
			printf("\n--------------------------------------------------------------\n");
			printf("%s был успещно удален из базы данных\n", name);
			printf("--------------------------------------------------------------\n\n");
	...
	printf("\n--------------------------------------------------------------\n");
	printf("Героя с таким именем не существует!\n");
	printf("--------------------------------------------------------------\n\n");
}
...
int main() {
	...
	while (cnt == true) {
		...
		case 1: 
			read_from_file(&start);
			printf("--------------------------------------------------------------\n");
			printf(" Герои были успешно считаны из файла\n");
			printf("--------------------------------------------------------------\n");
			break;
		...
		case 5:
			...
			start = NULL;
			printf("\n--------------------------------------------------------------\n");
			printf("База данных была успешно очищена!\n");
			printf("--------------------------------------------------------------\n\n");
			break;
		case 4:
			//char name[30] = "";
		...
		case 6:
			...
			printf("\n--------------------------------------------------------------\n");
			printf(" Все герои были успешно выведены в файл!\n");
			printf("--------------------------------------------------------------\n\n");
			break;
		case 0:
			cnt = false;
